# Generated by Django 2.2 on 2020-01-10 07:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 8 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=100, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
                ...
                ('role', models.CharField(choices=[('ADMIN', 'ADMIN'), ('USER', 'USER')], max_length=50, verbose_name='Role')),
                ('profile_pic', models.FileField(blank=True, max_length=1000, null=True, upload_to=Common.models.img_url, verbose_name='Profile Picture')),
                ('has_manager_access', models.BooleanField(default=False, verbose_name='Manager Access')),
                ('has_supervisor_access', models.BooleanField(default=False, verbose_name='Supervisor Access')),
                ('has_staff_access', models.BooleanField(default=False, verbose_name='Staff Access')),
